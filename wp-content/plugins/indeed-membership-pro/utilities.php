...
function ihc_locker_meta_keys(){
	...
	$arr = array(
					'ihc_locker_name' => 'Безымянный Замок',
					'ihc_locker_custom_content' => '<h2>Этот контент заблокирован</h2>
													Войдите, чтобы разблокировать контент!',
	...
	switch ($type){
		...
		case 'payment_authorize':
			$arr = array(
							...
							'ihc_authorize_label' => 'Авторизовать',
...
<p>Пожалуйста, продолжите оплату банковским переводом за: {currency}{amount}</p>

<p><strong>Детали оплаты:</strong> Подписка {level_name} для {username} с идентификацией: {user_id}_{level_id}</p>
...
НАЗВАНИЕ банка<br/>',
					'ihc_bank_transfer_label' => 'Банковский перевод',
		...
		case 'payment_stripe_connect':
			$arr = array(
							...
							'ihc_stripe_connect_label' 									=> 'Кредитная карта',
			);
			break;
		case 'login':
			$arr = array(
		...
		case 'login-messages':
			$arr = array(
							'ihc_login_succes' => 'Добро пожаловать на наш сайт!',
							'ihc_login_pending' => 'Ваш аккаунт не одобрен. Пожалуйста, повторите попытку позже',
							'ihc_social_login_failed' => 'Вы не зарегистрированы в этой социальной сети. Пожалуйста, сначала зарегистрируйтесь!',
							'ihc_login_error' => 'Введен неверный адрес электронной почты или пароль',
							'ihc_reset_msg_pass_err' => 'Введен неверный адрес электронной почты или имя пользователя',
							'ihc_reset_msg_pass_ok' => 'Новый пароль был отправлен на ваш адрес электронной почты',
							'ihc_login_error_email_pending' => 'Адрес электронной почты еще не подтвержден',
							'ihc_login_error_on_captcha' => 'Ошибка с капчей',
							'ihc_login_error_ajax' => 'Пожалуйста, заполните все обязательные поля',
						);
		break;
		...
		case 'general-msg':
			$arr = array(
							'ihc_general_update_msg' => 'Успешно обновлено!',
						);
		break;
		case 'register':
			$arr = array(
							...
							'ihc_register_terms_c' => 'Примите наши правила и условия',
		...
		case 'register-msg':
			$arr = array(
							//messages
							'ihc_register_username_taken_msg' => 'Имя пользователя уже занято',
							'ihc_register_error_username_msg' => 'Неверное имя пользователя',
							'ihc_register_email_is_taken_msg' => 'Email адрес уже занят',
							'ihc_register_invalid_email_msg' => 'У вас должен быть действующий адрес электронной почты',
							'ihc_register_emails_not_match_msg' => 'Email Адреса не совпадают',
							'ihc_register_pass_not_match_msg' => 'Новые пароли не совпадают',
							'ihc_register_pass_letter_digits_msg' => 'Пароль должен содержать как буквы, так и цифры',
							'ihc_register_pass_let_dig_up_let_msg' => 'Пароль должен содержать символы, цифры и хотя бы одну заглавную букву.',
							'ihc_register_pass_min_char_msg' => 'Пароль должен содержать минимум {X} символов.',
							'ihc_register_pending_user_msg' => 'Ваша учетная запись еще не одобрена. Пожалуйста, повторите попытку позже',
							'ihc_register_err_req_fields' => 'Пожалуйста, заполните все обязательные поля',
							'ihc_register_err_recaptcha' => 'Ошибка с капчей',
							'ihc_register_err_tos' => 'Пожалуйста, согласитесь с нашими Условиями использования',
							'ihc_register_success_meg' => '<h4>Успешно зарегистрируйтесь!</h4>
<br/>',
							'ihc_register_update_msg' => 'Успешно обновлено!',
							'ihc_register_unique_value_exists' => 'Это значение уже существует.',
						);
		break;
		...
		case 'account_page':
			$arr = array(	'ihc_ap_theme' => 'ihc-ap-theme-3',
							...
							'ihc_ap_welcome_msg' => '<span class="iump-user-page-mess-special">Привет</span> <span class="iump-user-page-mess-special"> {last_name} {first_name}</span>,
														<span class="iump-user-page-mess">Вы вошли как</span><span class="iump-user-page-mess-special"> {username}</span>
														<div class="iump-user-page-mess"><span>{flag}</span>Участник с {user_registered}</div>
														',
							'ihc_account_page_custom_css' => '',
							'ihc_ap_social_plus_message' => '',

							'ihc_ap_overview_menu_label' => 'Панель',
							'ihc_ap_overview_title' => 'Панель',
							'ihc_ap_overview_msg' => '<p>Добро пожаловать на нашу платформу для участников. Проверьте наличие ценного контента и подпишитесь на наши подписки.</p><p>С панели управления членством вы можете управлять <strong>своими подписками</strong>, проверять <strong>последние платежи</strong> или редактировать свою <strong>учетную запись. подробности</strong>.</p>',
							'ihc_ap_overview_icon_class' => '',
							'ihc_ap_overview_icon_code' => 'f015',
							'ihc_ap_profile_menu_label' => 'Детали профиля',
							'ihc_ap_profile_title' => 'Отредактируйте свою учетную запись',
							'ihc_ap_profile_msg' => '',
							'ihc_ap_profile_icon_class' => '',
							'ihc_ap_profile_icon_code' => 'f007',
							'ihc_ap_subscription_menu_label' => 'Подписки',
							...
							'ihc_ap_social_menu_label' => 'Социальные связи',
							'ihc_ap_social_title' => 'Социальные связи',
							'ihc_ap_social_icon_class' => '',
							'ihc_ap_social_icon_code' => 'f0e6',
							'ihc_ap_social_msg' => '',
							'ihc_ap_transactions_menu_label' => 'Транзакции',
							'ihc_ap_transactions_title' => 'Транзакции',
							'ihc_ap_transactions_msg' => '',
							'ihc_ap_transactions_icon_class' => '',
							'ihc_ap_transactions_icon_code' => 'f155',
							'ihc_ap_orders_menu_label' => 'Платежи',
							'ihc_ap_orders_title' => 'Платежи',
							'ihc_ap_orders_msg' => '',
							'ihc_ap_orders_icon_class' => '',
							'ihc_ap_orders_icon_code' => 'f0d6',
							'ihc_ap_membeship_gifts_menu_label' => 'Подарки за членство',
							'ihc_ap_membeship_gifts_title' => 'Подарки за членство',
							'ihc_ap_membeship_gifts_msg' => '[ihc-list-gifts]',
							'ihc_ap_membeship_gifts_icon_class' => '',
							'ihc_ap_membeship_gifts_icon_code' => 'f06b',
							'ihc_ap_membership_cards_menu_label' => 'Членские карты',
							'ihc_ap_membership_cards_title' => 'Членские карты',
							'ihc_ap_membership_cards_msg' => '[ihc-membership-card]',
							'ihc_ap_membership_cards_icon_class' => '',
							'ihc_ap_membership_cards_icon_code' => 'f022',
							'ihc_ap_help_menu_label' => 'Помощь',
							'ihc_ap_help_title' => 'Помощь',
							'ihc_ap_help_msg' => 'Если у вас есть какие-либо вопросы или вам нужна помощь, пожалуйста, не стесняйтесь обращаться к нам..',
							'ihc_ap_help_icon_class' => '',
							'ihc_ap_help_icon_code' => 'f059',
							'ihc_ap_pushover_notifications_menu_label' => 'Пуш уведомления',
							'ihc_ap_pushover_notifications_title' => 'Пуш уведомления',
							'ihc_ap_pushover_notifications_msg' => '',
							'ihc_ap_pushover_notifications_icon_class' => '',
							'ihc_ap_pushover_notifications_icon_code' => 'f0f3',
							'ihc_ap_logout_menu_label' => 'Выйти',
							'ihc_ap_logout_icon_class' => '',
							'ihc_ap_logout_icon_code' => 'f08b',
							'ihc_ap_affiliate_icon_class' => '',
							'ihc_ap_affiliate_icon_code' => 'f0e8',

							'ihc_ap_user_sites_label' => 'Ваши сайты',
							'ihc_ap_user_sites_title' => 'Ваши сайты',
		...
		case 'social_media':
			$arr = array(
							...
							"ihc_sm_custom_css" => "",
							"ihc_sm_show_label" => 1,
							'ihc_sm_top_content' => '<div class="ihc-top-social-login"> - ИЛИ - </div>',
...
<p><span class="iump-user-page-mess">Имя пользователя:</span><span class="iump-user-page-mess-special"> {username}</span>
</p>
<p><span class="iump-user-page-mess">и его/ее замечательный адрес электронной почты : <strong>{user_email}</strong></span></p>
	  ...
	  case 'security':
		...
		case 'invoices':
			$arr = array(
							...
							'ihc_invoices_company_field' => '<div><b>Название вашей компании ООО</b></div>
<div>Уникальный код: #99991239</div>
<div>Адрес компании: ваш адрес электронной почты</div>',
							'ihc_invoices_bill_to' => '<div><b>Счет к</b></div>
<div><b>Name: </b>{first_name} {last_name} </div>
<div><b>E-mail: </b>{user_email} </div>
<div><b>Адрес: </b>{CUSTOM_FIELD_addr1}</div>',
							'ihc_invoices_title' => 'Ваш счет на заказ',
							'ihc_invoices_template' => '',
							'ihc_invoices_logo' => IHC_URL . 'assets/images/default-logo1.png',
							'ihc_invoices_custom_css' => '',
							'ihc_invoices_footer' => 'Если у вас есть какие-либо вопросы по поводу этого счета, пожалуйста, свяжитесь с нами!',
			);
			break;
		case 'woo_payment':
			$arr = array(
		...
		case 'reason_for_cancel':
			$arr = array(
					...
					'ihc_reason_for_cancel_resons'				=> "У меня нет времени, 
					содержание вашего сайта не удовлетворяет меня"
			);
			break;
		...
		case 'checkout-settings':
			$arr = [
					...
					'ihc_checkout_privacy_policy_message'			=> 'Ваши личные данные будут использованы для обработки вашего заказа, поддержки вашего опыта на этом сайте и для других целей',
			...
			case 'checkout-messages':
				$arr = [
					'ihc_checkout_customer_title' 								=> 'Информация о клиенте',
					'ihc_checkout_payment_title'									=> 'Способ оплаты',
					'ihc_checkout_taxes_title'										=> 'Налоги',
					'ihc_checkout_coupon_field_message'						=> 'Если у вас есть код купона, примените его ниже',
					'ihc_checkout_coupon_field_used'							=> 'Купон',
					'ihc_checkout_apply_button'  									=> 'Применить',
					'ihc_checkout_price_initial'									=> 'Первоначальный платеж',
					'ihc_checkout_price_then'											=> 'Затем',
					'ihc_checkout_price_fee'											=> 'Платеж',
					'ihc_checkout_price_free'											=> 'Бесплатно',
					'ihc_checkout_price_discount'									=> 'Скидка',
					'ihc_checkout_price_every'							  		=> 'каждый',
					'ihc_checkout_price_for'							  			=> 'для',
					'ihc_checkout_dynamic_field_message'					=> 'Выберите, сколько вы хотите за это заплатить.',
					'ihc_checkout_dynamic_price-set'			  			=> 'Выбранная цена',
					'ihc_checkout_dynamic_field_button'			  		=> 'Применять',
					'ihc_checkout_subtotal_title'									=> 'Итого',
					'ihc_checkout_purchase_button'								=> 'Завершить покупку',
					'ihc_checkout_free_button'										=> 'Свободный доступ',
			...
			case 'thank-you-page-settings':
				$arr = [
					'ihc_thank_you_message'			    => '<h5 class="primary">Спасибо за покупку!</h5>
<p>&nbsp;</p><div><p><strong>Привет {customer_name},</strong></p> <p>Это подтверждение того, что мы только что получили ваш безопасный онлайн-платеж.({amount}{currency}) через {order_payment_method} для <strong>{membership_name}</strong>.</p>
<p>Ваш заказ <strong>#{order_code}</strong> были размещены. Проверьте свой почтовый ящик на <strong>{customer_email}</strong> для получения более подробной информации.</p>
<p>Thank you for your trust.</p></div>',
					'ihc_thank_you_error_message'		=> 'Извини! Недостаточно доступной информации.',
...
function ihc_native_user_field(){
	...
	$arr = array(
			array( 'display_admin'=>2, 'display_public_reg'=>2, 'display_public_ap'=>2, 'display_on_modal'=> 2, 'name'=>'user_login', 'label'=>'Имя пользователя', 'type'=>'text', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			...
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'confirm_email', 'label'=>'Подтверждать Email', 'type'=>'text', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>1, 'display_public_ap'=>1, 'display_on_modal'=> 0, 'name'=>'first_name', 'label'=>'Имя', 'type'=>'text', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>1, 'display_public_ap'=>1, 'display_on_modal'=> 0, 'name'=>'last_name', 'label'=>'Фамилия', 'type'=>'text', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'user_url', 'label'=>'Веб-сайт', 'type'=>'text', 'native_wp' => 1, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>2, 'display_public_ap'=>1, 'display_on_modal'=> 1, 'name'=>'pass1', 'label'=>'Пароль', 'type'=>'password', 'native_wp' => 1, 'req' => 1, 'sublevel' => '' ),
			array( 'display_admin'=>1, 'display_public_reg'=>1, 'display_public_ap'=>1, 'display_on_modal'=> 0, 'name'=>'pass2', 'label'=>'Подтвердите пароль', 'type'=>'password', 'native_wp' => 1, 'req' => 2, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'description', 'label'=>'Биографическая информация', 'type'=>'textarea', 'native_wp' => 1, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'phone', 'label'=>'Телефон', 'type'=>'number', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'addr1', 'label'=>'Адрес 1', 'type'=>'textarea', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'addr2', 'label'=>'Адрес 2', 'type'=>'textarea', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			...
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'city', 'label'=>'Город', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'thestate', 'label'=>'Область', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'country', 'label'=>'Страна', 'type'=>'text', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>1, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'ihc_country', 'label'=>'Страна', 'type'=>'ihc_country', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),
			...
			array( 'display_admin'=>0, 'display_public_reg'=>1, 'display_public_ap'=>1, 'display_on_modal'=> 0, 'name'=>'ihc_avatar', 'label'=>'Аватар', 'type'=>'upload_image', 'native_wp' => 0, 'req' => 0, 'sublevel' => '' ),
			array( 'display_admin'=>0, 'display_public_reg'=>1, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'tos', 'label'=>'Принять', 'type'=>'checkbox', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),
			...
			array( 'display_admin'=>0, 'display_public_reg'=>0, 'display_public_ap'=>0, 'display_on_modal'=> 0, 'name'=>'ihc_invitation_code_field', 'label'=>'Пригласительный код', 'type'=>'ihc_invitation_code_field', 'native_wp' => 0, 'req' => 2, 'sublevel' => '' ),
...
function ihc_get_active_payments_services($only_keys=FALSE){
	...
	foreach ($gateways_without_labels as $k){
		...
		if ($data['status'] && $data['settings']=='Завершено'){
			if ($only_keys){
				$arr[] = $k;
			} else {
				$arr[$k] = $gateways[$k];
...
function iump_is_wizard_uncompleted_but_not_skiped( $global=false )
{
		if ( (int)get_option( 'iump_wizard_complete', 0 ) === -2 ){
				...
				$responseMessage .= "<p>";
				$responseMessage .= "<strong>" . esc_html( 'Warning:', 'ihc')  ."</strong>" . esc_html__( ' Похоже, что ', 'ihc') . '<a href="' . esc_url( admin_url( 'admin.php?page=ihc_manage&tab=wizard' ) ) . '"> ' . esc_html__( 'Wizard Setup',  'ihc' ) . '</a>' . esc_html__( ' не был завершен. Пожалуйста, заполните ', 'ihc') . '<a href="' . esc_url( admin_url( 'admin.php?page=ihc_manage&tab=wizard' ) ) .'">' . esc_html__('setup', 'ihc') . '</a>' . esc_html__(' чтобы обеспечить правильную функциональность.', 'ihc' );
