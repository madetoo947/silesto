            ...
            <div class="col-xs-8">
              ...
              <p><?php esc_html_e('Members may be able to logout from their Account', 'ihc');?></p>
						...
						<div class="iump-form-line">
							...
							<p><?php esc_html_e('Пользователи могут изменять данные своего профиля, управлять членством в клубе или проверять свои платежи.', 'ihc');?></p>
						...
						<div class="iump-form-line">
							...
							<p><?php esc_html_e('Страница "Условия предоставления услуг", доступная из формы регистрации, когда пользователь должен принять условия сайта', 'ihc');?></p>
						...
						<div class="iump-form-line">
							...
							<p><?php esc_html_e('Доступно для незалогиненных пользователей, чтобы сбросить утерянный пароль', 'ihc');?></p>
						...
						<div class="iump-form-line">
							...
							<p><?php esc_html_e('Выделенная для участников витрина каталога с доступной публичной индивидуальной страницей', 'ihc');?></p>
						...
						<div class="iump-form-line">
							...
							<p><?php esc_html_e('Участники могут завершить оплату выбранного членства на портале участника или на странице регистрации', 'ihc');?></p>
						...
						<div class="iump-form-line">
							...
							<p><?php esc_html_e('Шаг подтверждения после завершения платежа', 'ihc');?></p>
...
<?php $pages_arr = $pages + ihc_get_redirect_links_as_arr_for_select();?>
				<div class="ihc-stuffbox">
					<h3><?php esc_html_e('Настройка перенаправления', 'ihc');?></h3>
					<div class="inside">
						<div class="iump-form-line">
							<h4><?php esc_html_e('Default Redirect Page', 'ihc');?></h4>
							<p><?php esc_html_e('Если доступ ограничен и не задан определенный вариант перенаправления, будет использоваться вариант по умолчанию', 'ihc');?></p>
						...
						<div class="iump-form-line">
							<h4><?php esc_html_e('После выхода из системы', 'ihc');?></h4>
						...
						<div class="iump-form-line">
							<h4><?php esc_html_e('После регистрации', 'ihc');?></h4>
							<p><?php esc_html_e('Если после регистрации не происходит никакого другого перенаправления, новые пользователи могут быть перенаправлены на определенную страницу', 'ihc');?></p>
							...
							<div><?php esc_html_e("За исключением случаев, когда используется оплата банковским переводом", 'ihc');?></div>
						</div>

						<div class="iump-form-line">
							<h4><?php esc_html_e('После входа в систему', 'ihc');?></h4>
							<p><?php esc_html_e('Он может перенаправить вошедших в систему пользователей на портал для пользователей', 'ihc');?></p>
						...
						<div class="iump-form-line">
							<h4><?php esc_html_e('После сброса пароля', 'ihc');?></h4>
							<p><?php esc_html_e('Пользовательская страница, на которую могут быть перенаправлены незалогиненные пользователи после отправки сообщения о сбросе пароля', 'ihc');?></p>
        ...
        <div class="ihc-stuffbox">
          <div class="inside">
						<div class="ihc-wrapp-submit-bttn">
							<input id="ihc_submit_bttn" type="submit" value="<?php esc_html_e('Сохранить изменения', 'ihc');?>" name="ihc_save" class="button button-primary button-large" />
						</div>
					</div>
				</div>
			</form>
