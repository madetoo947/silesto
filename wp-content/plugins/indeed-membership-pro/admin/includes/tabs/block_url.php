...
<form method="post"  id="block_url_form">
	...
	<?php
			...
			<?php
				...
				if ($data && count($data)){
						...
						<div class="iump-rsp-table">
							<form action="" method="post" class="ihc-coupons-lists-wrapper" data-delete_many_coupons="<?php esc_html_e( 'Вы уверены, что хотите удалить выбранные купоны?', 'ihc' );?>" >
							<table id="iump-dashboard-table" class="display iump-dashboard-table ihc-display-none iump-js-coupons-table"  >
											<thead>
													<tr>
															...
															<th class="iump-dashboard-table-head-col iump-dashboard-table-col-sorting"><?php esc_html_e('Тип ограничения', 'ihc');?></th>
															<th class="iump-dashboard-table-head-col iump-dashboard-table-col-sorting"><?php esc_html_e('Целевые члены', 'ihc');?></th>
															<th class="iump-dashboard-table-head-col iump-dashboard-table-col-sorting"><?php esc_html_e('Перенаправление после', 'ihc');?></th>
															<th class="iump-dashboard-table-head-col iump-dashboard-table-col-sorting"><?php esc_html_e('Удалить', 'ihc');?></td>
													</tr>
											</thead>
									</table>
		...
		case 'keyword':
			...
			?>
				<div class="ihc-stuffbox">
					<h3><?php esc_html_e('Добавить новое ограничение', 'ihc');?></h3>
					<div class="inside">
						<div class="iump-form-line">
							<h2><?php esc_html_e('Ограничение любой страницы на основе ключевых слов', 'ihc');?></h2>
							<p><?php esc_html_e('Основываясь на определенном ключевом слове, расположенном в ссылке, вы можете ограничить количество страниц, проходящих через ваш сайт WordPress.', 'ihc');?></p>
						</div>
						<div class="iump-form-line">
							<div class="row">
									<div class="col-xs-4">
							...
							<div class="iump-form-line iump-special-line">
								<div class="iump-form-line">
									<?php
										$type_values = array(
																'show' =>esc_html__('Показать только для....', 'ihc'),
																'block' =>esc_html__('Блок только для....', 'ihc')
								...
								<div class="iump-form-line">
									...
									<div id="iump_admin_car_target_message" class="iump-admin-car-target-message" data-notice="<?php esc_html_e( 'Пожалуйста, заполните это поле', 'ihc');?>"></div>
								</div>
							</div>

							<div class="iump-form-line">
								<h4><?php esc_html_e('Перенаправление после', 'ihc');?></h4>
								<p><?php esc_html_e('Выберите место, куда будут перенаправлены пользователи в случае ограничения доступа. Страница перенаправления по умолчанию будет использоваться, если не выбрана конкретная опция', 'ihc');?></p>
				...
				<div class="ihc-stuffbox">
					...
					<div class="inside">
						<div class="iump-form-line iump-no-border">
							...
							<p><?php esc_html_e('Выберите один из пользовательских типов постов, которые в настоящее время зарегистрированы на вашем сайте WordPress', 'ihc');?></p>
