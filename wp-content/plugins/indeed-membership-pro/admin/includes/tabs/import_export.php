...
wp_enqueue_script( 'ump-admin-import-export', IHC_URL . 'admin/assets/js/csv_export.js', [ 'jquery' ], '13.0' );
?>
<?php
		...
		<div class="ihc-stuffbox">
			...
			<div class="inside">
				<div class="iump-form-line">
					<h2><?php esc_html_e('Экспорт Members', 'ihc');?></h2>
					<p><?php esc_html_e('Экспортируйте список участников в CSV-файл, чтобы получить подробную информацию о членах в удобном формате.', 'ihc');?></p>
				</div>
				<div class="iump-form-line ump-export-csv-filters-wrap">
					...
					<div class="iump-datatable-filters-wrapper"  id="ump_js_import_export_wrapp_for_members">
							...
							<div class="iump-datatable-multiselect-wrapp">
									...
									?>
									<select name="memberships[]" class="iump-export-filter-users-memberships ms-list-1" multiple data-placeholder="<?php esc_html_e("Выберите членство", 'ihc');?>" >
											<?php if ( $levels_arr ):?>
							...
							<div class="iump-datatable-multiselect-wrapp">
									...
									?>
									<select name="membership_status[]" class="iump-export-filter-users-membership-status" multiple data-placeholder="<?php esc_html_e("Статус членства", 'ihc');?>" >
...
<div class="ihc-stuffbox">
	...
	<div class="inside">
			...
			<div class="iump-form-line">
				...
				<p><?php esc_html_e('Экспортируйте настройки Ultimate Membership Pro для этого сайта в файл .xml. Это позволит вам легко импортировать конфигурацию на другой сайт.', 'ihc');?></p>
				<label class="iump_label_shiwtch ihc-switch-button-margin">
			...
			<div class="iump-form-line">
				...
				<p><?php esc_html_e('Экспортируйте настройки ограничений Posts для этого сайта в файл .xml. Это позволит вам легко импортировать их на другой сайт.', 'ihc');?></p>
				<label class="iump_label_shiwtch ihc-switch-button-margin">
	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			<div class="iump-form-line">
				...
				<p><?php esc_html_e('Импортируйте файл .xml с другого сайта WordPress, который был создан с помощью плагина Ultimate Membership Pro.', 'ihc');?></p>
			</div>
			<div class="iump-form-line">
	...
	<div class="ihc-stuffbox">
		...
		<div class="inside">
			<div class="iump-form-line">
				...
				<p><?php esc_html_e('Импортируйте файл .csv с другого сайта WordPress, созданного с помощью плагина Ultimate Membership Pro.', 'ihc');?></p>
			</div>
			<div class="iump-form-line">
				<input type="file" name="import_file" />
			</div>
