...
if(isset($subscriptions) && is_array($subscriptions) && count($subscriptions) > 0){
		// Сортируем по названию (A-Z), сохраняя ключи
...
wp_enqueue_script( 'ihc-user-membership-management', IHC_URL . 'admin/assets/js/user-memberships-management.js', ['jquery'], '13.0' );
?>
